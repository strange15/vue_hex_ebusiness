export default {
    ...
    CHECK_IS_LOGIN: 'https://vue-course-api.hexschool.io/api/user/check', // 驗證是否有登入
    ...
    LIST_ALL_COUPONS: 'https://vue-course-api.hexschool.io/api/strange/admin/coupons', // 顯示所有優惠券
    UPDATE_COUPON: 'https://vue-course-api.hexschool.io/api/strange/admin/coupon', // 新增/更新優惠券
    DELETE_COUPON: 'https://vue-course-api.hexschool.io/api/strange/admin/coupon', // 刪除優惠券
    USE_COUPON: 'https://vue-course-api.hexschool.io/api/strange/coupon', // 套用優惠券
    ...
    GET_ORDERS: 'https://vue-course-api.hexschool.io/api/strange/orders', // 取得訂單列表
